  ...
  return (
    ...
    <div>
        ...
        <Routes>
          ...
          <Route path="/typingGame" element={<TypingGame token={token} />}></Route>
          <Route path="/typingResult" element={<TypingResult />}></Route>
          <Route path="/signup" element={<Signup  onSignup={signupHandler}/>}></Route>
          <Route path="/login_pg" element={<Login onLogIn={loginHandler} />}></Route>
          <Route path="/profile" element={<Profile userId={userId} token={token} />}></Route>
          <Route path="/imagequiz" element={<ImageQuiz token={token} userId={userId} />}></Route>
          {/* <Route path="/memorygame" element={<MemoryGame token={token} userId={userId} />}></Route> */}
